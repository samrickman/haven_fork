...
Haven plus is exactly like Haven - except that it allows a larger MALLOC size. This should hopefully fix the issue where a very long string in a Stata file with a lot of rows causes MAX MALLOC error.
